...
@if(App\Models\Image::exists())
    <img src="{{ asset('bookme/public/uploads/' . App\Models\Image::first()->file_name) }}" alt="Latest Image" class="w-screen h-screen object-cover">
@else
    ...
    <div class="w-[95%] mx-auto">
        <div class="container mx-auto mt-4">
            <div class="flex item-center justify-between">
                ...
                <h2 class="text-2xl font-bold mb-4">Activities Property List: </h2>
                <a
                    ...
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="px-4 py-2 text-left">Price</th>
                             <th class="px-4 py-2 text-left">Discount Message</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <form action="{{ route('properties.update', $property->property_id) }}" method="POST"
                                ...
                                <td>
                                    <textarea  name="popularity"
                                        class="w-full border border-gray-300 rounded px-2 py-1 resize-none"
                                        disabled>{{ $property->popularity }}</textarea>
                                </td>
                                 <td>
                                    <textarea required name="price"
                                        class="w-full border border-gray-300 rounded px-2 py-1 resize-none"
                                        disabled>{{ $property->price }}</textarea>
                                </td>
                                 <td>
                                    <textarea  name="discout"
                                        class="w-full border border-gray-300 rounded px-2 py-1 resize-none"
                                        disabled>{{ $property->discout }}</textarea>
                                </td>
                                ...
                                <!-- <td>
                                    <input type="checkbox" name="popularity"
                                        class="w-4 h-4 text-blue-600 border border-gray-900 rounded px-3 py-1 resize-none"
                                        value="1" disabled
                                        {{ old('popularity') || $property->popularity ? 'checked' : '' }} />
                                </td> -->
...
<a href="/admin/property_images/{{$property->property_id}}"
   class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-500 save-button">
   Add Image
</a>

<a href="/admin/packages/{{$property->property_id}}"
   class="bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-500 save-button">
   Add Packages
</a>

<a href="/admin/pickup-locations/{{$property->property_id}}"
   class="bg-indigo-600 text-white px-3 py-1 rounded hover:bg-indigo-500 save-button">
   Add Pickup Destinations
</a>

<a href="/admin/itineraries/create/{{$property->property_id}}"
   class="bg-indigo-600 text-white px-3 py-1 rounded hover:bg-indigo-500 save-button">
   Add Itinerary
</a>
                        ...
                        <form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 grid-cols-1 sm:grid-cols-2">
                                ...
                                <div>
                                   ...
                                   <div>
                                    <label for="discout"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Discount Message<span
                                        class="text-red-500 font-bold text-2xl">*</span></label>
                                    <input type="text" id="popularity" name="discout"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:text-white">
                                </div>
                                 <div>
                                    <label for="price"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Starting Price<span
                                        class="text-red-500 font-bold text-2xl">*</span></label>
...
<div>
    ...
    <textarea id="keywords" name="kewords"
        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:text-white"
        rows="3"></textarea>
</div>
