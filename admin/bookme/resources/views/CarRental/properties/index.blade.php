        ...
        <div class="w-[95%] mx-auto">
            <div class="container mx-auto mt-4">
                <div class="flex item-center justify-between">
                    <h2 class="text-2xl font-bold mb-4">Property/Car List: </h2>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="/admin/facilities/{{$property->property_id}}"
                                    ...
                                    details</a>
                                 <a href="/admin/car-prices/{{$property->property_id}}"
                                    class="bg-green-600 text-white px-3 py-1 rounded hover:bg-yellow-500  save-button">Add
                                    Price</a>
                                ...
                                <div class="grid gap-4 grid-cols-1 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <select id="brand_id" name="brand_id"
                                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-800 dark:text-white dark:border-gray-600">
...
// Fixed brand-model selection script
    ...
    if (brandSelect) {
        brandSelect.addEventListener('change', function() {
            ...
            if (brandId) {
                ...
                fetch(`/admin/get-models/${brandId}`)
                    .then(response => {
                        if (!response.ok) {
