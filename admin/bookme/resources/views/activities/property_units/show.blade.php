...
<td>
    ...
    <div id="static-modal"  data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="p-4">
                   <form action="{{ route('property-units.store', $property_id) }}" method="POST" enctype="multipart/form-data" 
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                <label for="unit_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Package Name (Unit Name) <span class="text-red-500">*</span>
                </label>
                <input type="text" name="unit_name" id="unit_name" required
                    class="mt-1 w-full px-3 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                <label for="unit_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Package Type
                </label>
            ...
            <div>
                <label for="unit_no" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Duration (Unit Number) <span class="text-red-500">*</span>
                </label>
        ...
        <!-- Persons Allowed & Pickup -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                <label for="person_allowed" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Persons Allowed <span class="text-red-500">*</span>
                </label>
                <input type="number" name="person_allowed" id="person_allowed" required
                    class="mt-1 w-full px-3 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white">
            </div>

            <div>
                <label for="additionalbed" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Pick Up (Additional Bed) <span class="text-red-500">*</span>
                </label>
                <select name="additionalbed" id="additionalbed" required
                    class="mt-1 w-full px-3 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white">
        ...
        <!-- Main Image -->
        <div>
            <label for="mainimg" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Main Image <span class="text-red-500">*</span>
            </label>
            <input type="file" name="mainimg" id="mainimg" required accept="image/*"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                class="mt-1 w-full px-3 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white"></textarea>
        </div>
    ...
    <div class="mt-8 flex justify-end space-x-3">
        ...
        <button type="button"
            class="px-6 py-2 bg-gray-200 text-gray-900 font-medium rounded-lg shadow-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
            data-modal-hide="static-modal">
            Cancel
        </button>
    </div>
