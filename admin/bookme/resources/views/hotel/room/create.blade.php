        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div class="bg-blue-900 px-6 py-4 flex justify-between">
                    <h1 class="text-xl font-semibold text-white">Add New Room to {{ $hotel->name }}</h1>
                ...
                <!-- Form -->
                <form action="{{route('rooms.store', $hotel->id) }}" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-200" id="roomForm">
                    @csrf
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="max_guests_allowed" name="max_guests_allowed" value="{{ old('max_guests_allowed', 0) }}" min="0" required
                            ...
                            <div>
                                <label for="complementary_child_occupancy" class="block text-sm font-medium text-gray-700 mb-1">Complementary Child Occupancy Allowed <span class="text-red-500">*</span></label>
                                <input type="number" id="complementary_child_occupancy" name="complementary_child_occupancy" value="{{ old('max_guests_allowed', 0) }}" min="0" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('max_guests_allowed') border-red-500 @enderror">
                                @error('max_guests_allowed')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select id="extra_bed_available" name="extra_bed_available" required
                                    ...
                                    <option value="0" {{ old('extra_bed_available') == '0' ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ old('extra_bed_available') == '1' ? 'selected' : '' }}>Yes</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="smoking_status" name="smoking_status" required
                                    ...
                                    <option value="0" {{ old('smoking_status') == '0' ? 'selected' : '' }}>Non-Smoking</option>
                                    <option value="1" {{ old('smoking_status') == '1' ? 'selected' : '' }}>Smoking</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="breakfast_status" name="breakfast_status" required
                                    ...
                                    <option value="">-- Select breakfast_status --</option>
                                    <option value="included" {{ old('breakfast_status') == 'included' ? 'selected' : '' }}>included</option>
                                    <option value="not included" {{ old('breakfast_status') == "not included" ? 'selected' : '' }}>not included</option>
                                </select>
                            ...
                            <div class="relative">
                                ...
                                <div class="flex">
                                    <input type="number" id="room_size_sqft" name="room_size_sqft" value="{{ old('room_size_sqft') }}" min="0" step="0.01"
                            ...
                            <div>
                                ...
                                <input type="text" id="room_view" name="room_view" value="{{ old('room_view') }}"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="room_characteristics" name="room_characteristics" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('room_characteristics') border-red-500 @enderror">{{ old('room_characteristics') }}</textarea>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Main Photo -->
                            <div>
                                <label for="main_image" class="block text-sm font-medium text-gray-700 mb-1">Main Photo <span class="text-red-500">*</span></label>
                            ...
                            <!-- Additional Photos -->
                            <div>
                                <label for="images" class="block text-sm font-medium text-gray-700 mb-1">Additional Slider Photos</label>
