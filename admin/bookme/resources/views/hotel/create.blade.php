<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div class="bg-blue-900 px-6 py-4 flex justify-between">
                    <h1 class="text-xl font-semibold text-white">Add New Hotel</h1>
                    <a href="{{ url('/hotel/' . $id) }}" class="inline-flex items-center px-3 py-1 bg-green-900 text-white rounded hover:bg-yellow-600 text-sm">
                        Back To Hotel List
                    </a>
                </div>
                ...
                <!-- Form -->
                <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-200" id="hotelForm">
                    @csrf
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <input type="text" id="selected-categories" readonly 
                                        ...
                                        value="@if(old('category_ids')) 
                                            @php
                                                $oldCategoryIds = json_decode(old('category_ids'), true);
                                                $selectedCategories = $categories->whereIn('id', $oldCategoryIds)->pluck('name')->implode(', ');
                                            @endphp
                                            {{ $selectedCategories }}
                                        @endif">
                                ...
                                <input type="hidden" id="category_ids" name="category_ids" value="{{ old('category_ids') ? old('category_ids') : '[]' }}">
                                @error('category_ids')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="Year_of_construction" name="Year_of_construction" value="{{ old('Year_of_construction') }}"
                            ...
                            <div>
                                ...
                                <input type="number" id="number_of_rooms" name="number_of_rooms" value="{{ old('number_of_rooms') }}"
                            ...
                            <div class="md:col-span-2">
                                <label for="near_by" class="block text-sm font-medium text-gray-700 mb-1">Near By ( pipe (|) separated) eg: abc|cde|efg</label>
                                <input type="text" id="near_by" name="near_by" value="{{ old('near_by') }}"
                                    class="w-full h-12 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('near_by') border-red-500 @enderror">
                                @error('near_by')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="languages_spoken" name="languages_spoken"  value="{{ old('languages_spoken', 'Bangla, English') }}" placeholder="English, French, Spanish"
                            ...
                            <div>
                                ...
                                <input type="text" id="location_on_map" name="location_on_map" value="{{ old('location_on_map') }}" placeholder="https://maps.google.com/..."
                            ...
                            <div>
                                ...
                                <input type="text" id="extra_discount_msg" name="extra_discount_msg" value="{{ old('extra_discount_msg') }}" 
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="room_type" name="room_type" value="{{ old('room_type') }}" placeholder="Single, Double, Suite, etc."
                    ...
                    <div class="px-6 py-4">
                        <h2 class="text-lg font-medium text-gray-900 mb-4">Vat And Services</h2>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="vat" class="block text-sm font-medium text-gray-700 mb-1">Vat Percentage (%)</label>
                                <input type="number" step="any" id="vat" name="vat" value="16.5" placeholder="16.5"
                             ...
                             <div>
                                <label for="service_charge" class="block text-sm font-medium text-gray-700 mb-1">Service Charge Percentage (%)</label>
                                <input type="number" id="service_charge" name="service_charge" value="10" placeholder="10"
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Main Photo -->
                            <div>
                                <label for="main_photo" class="block text-sm font-medium text-gray-700 mb-1">Main Photo</label>
                                ...
                                @error('main_photo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <div id="mainPhotoPreview" class="mt-2 hidden">
                                    <img id="mainPhotoPreviewImg" class="h-32 object-cover rounded border" alt="Main photo preview">
                            ...
                            <!-- Additional Photos -->
                            <div>
                                <label for="photos" class="block text-sm font-medium text-gray-700 mb-1">Hotel Slider Photos</label>
                                ...
                                @error('photos.*')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                                <div id="additionalPhotosPreview" class="mt-2 hidden grid grid-cols-3 gap-2"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 flex justify-between">
                        ...
                        <div>
                            ...
                            <button type="button" onclick="resetForm()" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-2">
                                Cancel
                            </button>
    ...
    <div id="category-modal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center hidden">
        <div class="bg-white p-6 rounded shadow-md w-96">
            ...
            <div class="max-h-96 overflow-y-auto mb-4">
                @php
                    $selectedCategoryIds = old('category_ids') ? json_decode(old('category_ids'), true) : [];
                @endphp
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('hotelForm').addEventListener('submit', function(e) {
                ...
                const additionalPhotos = document.getElementById('photos').files;
                
                // Check if main photo exceeds absolute max size
                if (mainPhoto && mainPhoto.size > ABSOLUTE_MAX_SIZE_BYTES) {
                    e.preventDefault();
                    showSizeError('Main photo exceeds maximum allowed size of 4MB. Please choose a smaller image.');
                    return;
                }
                ...
                if (additionalPhotos.length > 0) {
                    for (let i = 0; i < additionalPhotos.length; i++) {
                        if (additionalPhotos[i].size > ABSOLUTE_MAX_SIZE_BYTES) {
                            e.preventDefault();
                            showSizeError(`Photo "${additionalPhotos[i].name}" exceeds maximum allowed size of 4MB. Please choose a smaller image.`);
                            return;
                        }
                    }
                }
                ...
                if (mainPhoto && mainPhoto.size > MAX_IMAGE_SIZE_BYTES && !compressedMainFile) {
                    needsCompression = true;
                }
                
                if (additionalPhotos.length > 0) {
                    for (let i = 0; i < additionalPhotos.length; i++) {
                        if (additionalPhotos[i].size > MAX_IMAGE_SIZE_BYTES && 
                            (!compressedAdditionalFiles[i] || compressedAdditionalFiles[i].name !== additionalPhotos[i].name)) {
                            needsCompression = true;
                            break;
                        }
                    }
        ...
        function showImagePreviewThumbnail(file, type, index = null) {
            ...
            reader.onload = function(e) {
                if (type === 'main') {
                    const previewDiv = document.getElementById('mainPhotoPreview');
                    const previewImg = document.getElementById('mainPhotoPreviewImg');
        ...
        function showAbsoluteSizeError(file, type) {
            ...
            Swal.fire({
                ...
                if (type === 'main') {
                    ...
                    document.getElementById('additionalPhotosPreview').classList.add('hidden');
                }
            });
        }
                ...
                container.innerHTML = `
                    <div class="border rounded-lg p-4 relative">
                        ...
                        <div class="flex justify-between items-start mb-2">
                            <div>
                                <h4 class="font-medium">${type === 'main' ? 'Main Photo' : 'Additional Photo ' + (index + 1)}</h4>
        ...
        function removeImage(type, index) {
            if (type === 'main') {
                ...
                // Remove specific additional photo
        ...
        function updatePreviewButton() {
            ...
            const hasMainPhoto = document.getElementById('main_photo').files.length > 0;
            const hasAdditionalPhotos = document.getElementById('photos').files.length > 0;
            
            if (hasMainPhoto || hasAdditionalPhotos) {
        ...
        function prepareAndSubmitForm() {
            // Update main photo if compressed
            ...
            // Update additional photos if compressed
        ...
        function resetForm() {
            ...
            // Reset default values for vat and service charge
            document.getElementById('vat').value = '16.5';
            document.getElementById('service_charge').value = '10';
            document.getElementById('languages_spoken').value = 'Bangla, English';
            
            // Reset image previews and compressed files
            document.getElementById('mainPhotoPreview').classList.add('hidden');
            document.getElementById('additionalPhotosPreview').classList.add('hidden');
            document.getElementById('main_photo').value = '';
            document.getElementById('photos').value = '';
    ...
    <style>
        ...
        #additionalPhotosPreview img {
            transition: transform 0.2s;
        }
        #additionalPhotosPreview img:hover {
